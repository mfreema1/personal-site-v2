  ...
  return (
    <>
      <Page path={"/breadth"}>
        ...
        <Text>
          These pages will cover a broad variety of Software Engineering topics.
          The aim is to provide a birds-eye view of some tools and techniques
          that I have found useful. We will not dive terribly deep into each
          subject, but where possible, I will provide pointers or questions for
